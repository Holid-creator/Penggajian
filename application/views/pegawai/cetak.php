        ...
        <table class="table table-striped table-hover table-bordered">
            ...
            ?>
                ...
                <tr>
                    ...
                    <th>Rp. <?= number_format($cl->gaji_pokok + $cl->transport + $cl->uang_makan - $pot_gaji, 0, ',', '.') ?></th>
                </tr>
            <?php endforeach ?>
        </table>
        <table width="100%">
            <tr>
                <td><?= anchor('pegawai/gaji', '<div class="btn btn-primary">Kembali ke Slip Gaji</div>') ?></td>
                <td width="200px">
